...
glyphs = {
	...
	":": UDisplay.create_glyph(width = 1, height = 7, xoffset = 0, yoffset = 0, xadvance = 3, data = bytes((0x24, ))),
	"0": UDisplay.create_glyph(width = 5, height = 7, xoffset = 0, yoffset = -7, xadvance = 6, data = bytes((0x3e, 0x51, 0x49, 0x45, 0x3e))),
	"1": UDisplay.create_glyph(width = 3, height = 7, xoffset = 0, yoffset = -7, xadvance = 6, data = bytes((0x42, 0x7f, 0x40))),
